...
- Keep `skills/beautiful-repo/SKILL.md` concise and procedural.
...
```bash
python -m py_compile skills/beautiful-repo/scripts/audit_dl_repo.py
python skills/beautiful-repo/scripts/audit_dl_repo.py .
```
